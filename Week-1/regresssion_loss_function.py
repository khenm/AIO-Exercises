...
def regression_loss_function():
    ...
    if loss_name == 'MAE':
        ...
        for i in range(num_samples):
            ...
            print(f'loss name: {loss_name}, sample: {i}, pred: {predict_mae_x}, target: {target_mae_x}, loss: {loss}')
        final_loss /= num_samples # calculate MAE final loss by dividing it by number of samples
        # print final loss
    ...
    if loss_name == 'MSE':
        ...
        for i in range(num_samples):
            ...
            # display each sample result
            print(f'loss name: {loss_name}, sample: {i}, pred: {predict_mse_x}, target: {target_mse_x}, loss: {loss}')
        final_loss /= num_samples # calculate MSE final loss by dividing it by number of samples
        # print final loss
        print(f'final {loss_name}: {final_loss}')
    ...
    if loss_name == 'RMSE':
        ...
        for i in range(num_samples):
            ...
            # display each sample result
            print(f'loss name: {loss_name}, sample: {i}, pred: {predict_rmse_x}, target: {target_rmse_x}, loss: {loss}')
        final_loss /= num_samples # calculate RMSE final loss by dividing it by number of samples 
